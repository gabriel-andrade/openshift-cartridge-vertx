...
Once our environment is setup we can create our first application (we'll call it demo) using the rhc client tools.
    ...
    rhc app create demo https://raw.githubusercontent.com/gabriel-andrade/openshift-cartridge-vertx-integrator/master/metadata/manifest.yml

To create a scaled vertx application:

    rhc app create demo https://raw.githubusercontent.com/gabriel-andrade/openshift-cartridge-vertx-integrator/master/metadata/manifest.yml -s
